    ...
    <main style={{fontFamily:"system-ui,sans-serif",background:"#fff",color:"#1a1a1a"}}>
      ...
      <section id="home" style={{background:"linear-gradient(135deg,#fff5f5 0%,#fff8e1 50%,#fff 100%)",padding:"100px 2rem 80px",textAlign:"center",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{maxWidth:800,margin:"0 auto",position:"relative",zIndex:1}}>
          ...
          <h1 style={{fontSize:"clamp(2.5rem,6vw,4.5rem)",fontWeight:900,lineHeight:1.1,marginBottom:16,color:"#1a1a1a"}}>EduAI</h1>
          <h2 style={{fontSize:"clamp(1.8rem,4vw,3rem)",fontWeight:900,color:"#dc0000",marginBottom:24}}>Smart Learning Assistant</h2>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))",gap:16}}>
            {[
              ...
              <div key={title} style={{background:"white",borderRadius:20,padding:"1.5rem",border:"1px solid #f0f0f0",borderTop:`3px solid ${color}`}}>
                ...
                {items.map(item => (
                  <a key={item} href="/auth/login" style={{display:"block",color,fontSize:"0.875rem",textDecoration:"none",marginBottom:6,fontWeight:500}}>{item} →</a>
                ))}
              </div>
            ))}
          </div>
